...
aftorsChrisNolan = mapList.filter(aftor => aftor.director === "Christopher Nolan");

var averageRating = aftorsChrisNolan.reduce(function (total, item) {
    return total + Number(item.imdbRating) / aftorsChrisNolan.length;
}, 0);
